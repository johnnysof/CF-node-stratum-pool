...
var generateOutputTransactions = function(poolRecipient, recipients, rpcData, blockRewardMultiplier, metaData){

    var reward = rpcData.coinbasevalue * blockRewardMultiplier;
...
exports.CreateGeneration = function(rpcData, publicKey, extraNoncePlaceholder, reward, blockRewardMultiplier, txMessages, recipients, auxMerkleTree, metaData){
    ...
    var outputTransactions = generateOutputTransactions(publicKey, recipients, rpcData, blockRewardMultiplier, metaData);
