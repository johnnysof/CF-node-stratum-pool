...
console.log("blockhash-input:", headerBuffer.toString("hex"));
console.log("blockhash-o:", blockHash);
console.log("blockhash-a1:", util.reverseBuffer(hashDigest(headerBuffer, nTime)).toString('hex'));
